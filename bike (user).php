            ...
            <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item">
                <a class="nav-link" href="cart.php"><img src="assets/images/cart-36-xxl.png" alt="View Cart" width="25"></a></a>
                  ...
                  <li class="nav-item">
                <button class="btn btn-danger"><a class="nav-link" href="bike.php">LOG OUT</a></button>
              </li>
      ...
      ?>
                    ...
                    <div class="col-lg-4 col-md-4 all des">
                      <div class="product-item">
                        ...
                        <a href="#"><img src="assets/images/dhoom-3-bike-bmw-k1300r.jpg" alt=""></a>
...
<form action="cart_settings.php" method="post">

      <h4>ID</h4>

      <h7>Add the ID of the product which you want to purchase</h7></br>
